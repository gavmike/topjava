            ...
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control" id="name" name="dateTime"
                               placeholder="<spring:message code="meal.dateTime"/>">
                    </div>
                    <div class="form-group">
                        <label for="email" class="col-form-label"><spring:message code="meal.calories"/></label>
                        <input type="number" class="form-control" id="email" name="calories"
                               placeholder="<spring:message code="meal.calories"/>">
                    </div>

                    <div class="form-group">
                        <label for="password" class="col-form-label"><spring:message code="meal.description"/></label>
