...
public abstract class JdbcMealRepository <T> implements MealRepository {
  ...
  /*  private  Date date;
    ...
    public static class DateTimePostgres extends JdbcMealRepository<LocalDateTime>{
      public DateTimePostgres(JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
    ...
    public static class DateTimeHsqlDb extends JdbcMealRepository<Timestamp>{
        public DateTimeHsqlDb(JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
            super(jdbcTemplate, namedParameterJdbcTemplate);
        }
